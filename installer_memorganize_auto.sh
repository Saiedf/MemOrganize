...
#
# Example run:
# wget -qO- "https://raw.githubusercontent.com/Saiedf/MemOrganize/main/installer_memorganize_auto.sh?nocache=$(date +%s)" | /bin/sh
#
# Alternative:
# wget -O /tmp/installer_memorganize_auto.sh "https://raw.githubusercontent.com/Saiedf/MemOrganize/main/installer_memorganize_auto.sh?nocache=$(date +%s)" && chmod 755 /tmp/installer_memorganize_auto.sh && /bin/sh /tmp/installer_memorganize_auto.sh
# ==========================================================
